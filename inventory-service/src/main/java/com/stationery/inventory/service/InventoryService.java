...
public class InventoryService {
     ...
     * Called internally by request-service during request approval.
     *
    ...
    public boolean deductQuantity(Long itemId, Integer quantity) {
        ...
        // Prevent negative inventory. This check is crucial because multiple concurrent 
        // request approvals could otherwise drive stock below zero. If it fails here, 
        // the transaction in RequestService will be rolled back.
