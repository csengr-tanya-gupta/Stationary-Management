 ...
 * 
 * WHY IT EXISTS:
 * Defines the required payload for creating a new user account. It decouples the API contract 
 * from the database schema.
 * 
 * VALIDATION LOGIC:
 * - @NotBlank: Ensures the field isn't null or empty whitespace.
 * - @Email: Provides basic regex validation to ensure the email is well-formed.
 * - @Size: Enforces a minimum password length of 6 characters for security.
 * 
 * REAL-WORLD EXPLANATION:
 * This is the digital equivalent of a paper registration form. The annotations act as the 
 * bold red text saying "This field is required", ensuring the form isn't submitted half-empty.
 */
