...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleDecodeException(DecodeException ex) {
        log.error("Feign decode error: {}", ex.getMessage());
        ErrorResponse errorResponse = ErrorResponse.builder()
                .status(HttpStatus.BAD_GATEWAY.value())
                .message("Failed to decode response from inventory service: " + ex.getMessage())
                .timestamp(LocalDateTime.now())
                .build();
